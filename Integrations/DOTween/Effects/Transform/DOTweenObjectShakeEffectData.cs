...
namespace JuiceVFX
{
    [CreateAssetMenu(fileName = "NewDOTweenObjectShake", menuName = "AwesomeProjection/JuiceVFX/Effects/Transform/DOTween Object Shake")]
    public class DOTweenObjectShakeEffectData : ObjectShakeEffectData
    {
