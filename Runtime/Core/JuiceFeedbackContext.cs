...
namespace JuiceVFX
{
    ...
    public struct JuiceFeedbackContext
    {
        ...
        public JuiceFeedbackContext(Vector3? contactPoint = null, Quaternion? rotation = null, Gamepad[] gamepads = null, Renderer[] renderers = null, Transform rootTransform = null)
        {
